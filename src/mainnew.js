...
class LINE extends LineAPI {
    ...
    get myBot() {
        const bot = ['u45ac75d00ea685c99651e108b666c444o'];
        return bot; 
    }
    ...
    poll(operation) {
     ...
     {
let viproq = new Message();
viproq.to = operation.param1;
viproq.text = "Woooiii!!! Jangan Main Kick Sembarangan!!! Aku Kick Kamu Yaa, Byeee!!!"
this._client.sendMessage(0,viproq);
     }
            // op1 = group nya
            // op2 = yang 'nge' kick
            // op3 = yang 'di' kick
...
if(operation.type == 11) { //bukattupQR
     {
let viprouye = new Message();
viprouye.to = operation.param1;
viprouye.text = "Jangan Ubah Gambar Dan Nama Group/Jangan Dimainin QR-nya -__- Aku Kick Yaa !"+"Cuma Admin Yang Bisa!!!"
this._client.sendMessage(0,viprouye);
     }
            if(!this.isAdminOrBot(operation.param2)){
                this._kickMember(operation.param1,[operation.param2]);
            } 
...
let viprouye = new Message();
viprouye.to = operation.param1;
viprouye.text = "Byee~Byee... Jangan Balek Lagi Yaa Ke Group... Bikin Semak Aja... Makasih ^_^"
...
let viproq = new Message();
viproq.to = operation.param1;
viproq.text = "Terima Kasih Telah Invite Saya Di Group Anda ^_^\n\nSilahkan Ketik [/help] Untuk Mengetahui Command Bot Kami.\n\n~VIPRO~"
,"Invite Juga Vipro II Kesini ^_^"

this._client.sendMessage(0,viproq);
}
{
let vipro = new Message();
vipro.to = operation.param1;
vipro.text = "Invite Juga Vipro II Kesini ^_^"

this._client.sendMessage(0,vipro);
  }
}
...
let viproq = new Message();
viproq.to = operation.param1;
viproq.text = "Hallo Selamat Datang ^_^ Jangan Nakal Yaa Di Group Ini ^_^"
...
let viproq = new Message();
viproq.to = operation.param1;
viproq.text = "Kok Dibatalin? Emangnya Dia Siapa?"
...
let viproq = new Message();
viproq.to = operation.param1;
viproq.text = "Thx For Add Me 😘 Invite Me To Your Group ^_^"
this._client.sendMessage(0,viproq);
}
...
let viproq = new Message();
viproq.to = operation.param1;
viproq.text = "Jangan Main Invite Sembarangan... Siapa Tau Kicker 😧"
...
this.command('Halo', ['halo disini Vipro','kamu siapa?']);
this.command('Hi', ['hi disini Vipro','kamu siapa?']);

this.command('Vipro', ['Apa kak? ada yg bisa dibantu?','Ketik /help untuk bantuan']);
